...
Цикломатската комплексност на овој код е **3**, пресметана со формулата каде што E е вкупниот **број на ребра (17)**, N е вкупниот **број на јазли (16)**, а P е **бројот на поврзаност (1)**. Во овој случај, **цикломатската комплексност е 3**.
...
Тест случаи за покритието на многу услови:
